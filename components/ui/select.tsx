  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-full items-center justify-between gap-2 rounded-xl border px-4 py-3 text-sm font-poppins",
        "bg-gray-800/70 backdrop-blur-md border-gray-700 text-white shadow-lg",
        "data-[placeholder]:text-gray-400 whitespace-nowrap",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'bg-gray-800/95 backdrop-blur-md border border-gray-700 text-white shadow-2xl rounded-xl',
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Dark theme item styling
        "relative flex w-full cursor-default items-center gap-2 rounded-lg py-2.5 pr-8 pl-3 text-sm font-poppins",
        "text-gray-200 outline-hidden select-none transition-colors duration-150",
        // Focus and hover states
        "focus:bg-blue-600/20 focus:text-white hover:bg-gray-700/50",
        // Disabled state
