...
import { ArrowLeft, ExternalLink, Code, Calendar, ExternalLinkIcon } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="grid gap-8">
          {dummyPortfolio.map((item, idx) => (
            <div key={idx} className="bg-black/70 backdrop-blur-md border border-gray-700 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
              {/* Project Header */}
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {item.tech.map((tech, i) => (
                  <span key={i} className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getTechColor(tech)}`}>
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Button size="sm" className="bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 hover:from-blue-700 hover:via-indigo-600 hover:to-purple-600">
                  View Details
                </Button>
              </div>
            </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-black/70 backdrop-blur-md border border-gray-700 rounded-3xl p-8 shadow-xl max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Keep building and showcasing your technical skills with new projects.
            </p>
